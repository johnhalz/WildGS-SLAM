...
from wildgs_slam.utils.datasets import BaseDataset
...
class PoseTrajectoryFiller:
    ...
    def __call__(self, image_stream: BaseDataset):
        ...
        for timestamp, image, _, _ in tqdm(image_stream):
            ...
            if self.uncertainty_aware:
                dino_feature = predict_img_features(
                    self.feat_extractor, timestamp, image, self.cfg, self.device, save_feat=False
                )
