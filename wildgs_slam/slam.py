...
from wildgs_slam.backend import Backend
from wildgs_slam.depth_video import DepthVideo
from wildgs_slam.gui import gui_utils, slam_gui
from wildgs_slam.mapper import Mapper
from wildgs_slam.modules.droid_net import DroidNet
from wildgs_slam.tracker import Tracker
from wildgs_slam.trajectory_filler import PoseTrajectoryFiller
from wildgs_slam.utils.common import setup_seed, update_cam
from wildgs_slam.utils.datasets import BaseDataset, RGB_NoPose
from wildgs_slam.utils.dyn_uncertainty.uncertainty_model import generate_uncertainty_mlp
from wildgs_slam.utils.eval_traj import full_traj_eval, kf_traj_eval
    ...
    def run(self):
        ...
        if self.cfg["gui"]:
            ...
            gaussians = GaussianModel(
                self.cfg["mapping"]["model_params"]["sh_degree"], config=self.cfg
            )
