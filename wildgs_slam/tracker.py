...
from wildgs_slam.frontend import Frontend
from wildgs_slam.motion_filter import MotionFilter
    ...
    def run(self, stream: BaseDataset):
        ...
        for i in range(len(stream)):
            ...
            with torch.no_grad():
                ...
                if (starting_count < self.video.counter.value) and self.cfg["mapping"][
                    "full_resolution"
                ]:
